...
def compute(cell_capacity, method, resource_management):
    for x in range(0, 3):
        ...
        if len(lines) > 0:
            ...
            print("empty free" + str(gridSize_x[i]) + " " + str(gridSize_y[i]) + " " + str(robotsNumber_percent[j]) + " " + str(discs[k]) + " " + str(cell_capacity) + str(method) + str(resource_management))
...
def compute_grid(cell_capacity, method, resource_management):
    for x in range(0, 3):
        ...
        if len(lines) > 0:
            ...
            print("empty grid " + str(gridSize_x[i]) + " " + str(gridSize_y[i]) + " " + str(robotsNumber_percent[j]) + " " + str(discs[k]) + " " + str(cell_capacity) + str(method) + str(resource_management))
